                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form class="form-space theme-form row" method="post" action="controller/add_entry.php">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" type="number" name="mobile" min="0" required="">

                          </div>

                          <div class="col-12">

                            <label class="col-form-label">Total Entries</label>

                            <input class="form-control" type="number" name="entry" min="1" required="" >
