...
$sql_get = mysqli_query($con,"Select * FROM contest WHERE status='1' ORDER BY  edate ASC");
                              ...
                              <table class="display" id="example-style-1">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="view_entries.php?access_id=<?php echo $setdata['access_id'] ; ?>" class=""><i class="fa fa-eye"></i></a>
                                    ...
                                    <td>
                                        ...
                                        <a href="kwiki-details-edit.php?id=<?php echo $setdata['access_id'] ; ?>" class=""><i class="fa fa-edit"></i></a>

                                        <a href="controller/del_kwiki.php?id=<?php echo $setdata['access_id'];?>" class="" onclick="return confirm('Are you sure you want to delete this kwiki?');"><i class="fa fa-trash"></i></a>
