...
$sql_get = mysqli_query($con,"Select * FROM contest WHERE status='1'");
                              ...
                              <table class="display" id="example-style-1">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="view_kwiki.php?id=<?php echo $setdata['id'];?>" class=""><i class="fa fa-eye"></i></a></td>

                                    <td>
                                      <a href="contact-info-edit.php?id=<?php echo $setdata['access_id'];?>" class=""><i class="fa fa-edit"></i></a>
