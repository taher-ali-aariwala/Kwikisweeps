...
$sql = mysqli_query($con,"INSERT INTO `orders` (`time`, `date`, `order_id`, `fname`, `lname`, `email`, `mobile`,`price`,`entry`,`access_id`,`status`) VALUES ('$time', '$date', '$order_id', '$fname', '$lname', '$email', '$mobile','$price','$entry','$access_id','1')"); 
...
$mail->Mailer   = "smtp";
$mail->SetFrom("db.rahulpatwari@gmail.com",    "Sweepstakes");
$mail->AddReplyTo("db.rahulpatwari@gmail.com", "Sweepstakes");
                                        ...
                                        <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                            ...
                                            <tr>
                                                <td class='h1' style='padding: 5px 0 0 0;'>
                                                    Enquiry From Kwiki Sweepstakes
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <td valign='top' style='padding-left: 20px; padding-right: 20px;'>
                                                <table width='100%' edit-style='color_table' align='center' border='0' cellspacing='0' cellpadding='0'>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td valign='top' height='25' width='100' style='font-size: 18px; color: rgb(51, 51, 51); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 120%; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
                                                                <span style='text-decoration: none;line-height: 24px;font-size: 20px;color: rgb(51, 51, 51);font-weight: bold;'>Congratulations!</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td valign='top' height='25' width='100' style='font-size: 14px; color: rgb(136, 136, 136); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 30px; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
                                                                You have successfully purchased Kwiki ($title) through our Kwikis Sweepstakes portal. Please refer to the below link with having premium content(available to only our paid kwiki users).                                                               
                                                            </td>
                                                        </tr>
...
header('Location : ../view_entries.php?access_id='.$access_id.'&succ');
